...
export default function UpscaleImage() {
  const tool = getToolById('upscale-image')!;
    ...
    <ToolLayout tool={tool} resultVisible={result !== null}>
      <div className="space-y-6">
        <div className="rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-3 text-sm text-blue-700 dark:text-blue-300">
          This tool uses high-quality interpolation for upscaling. For enhanced upscaling, try the Upscale tool in the Enhancer section.
        </div>
